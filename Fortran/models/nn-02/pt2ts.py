# From https://github.com/Cambridge-ICCS/FTorch/blob/main/utils/pt2ts.py
...
from nn02 import Shock_Cell_Classifier
...
if __name__ == "__main__":
    ...
    trained_model = Shock_Cell_Classifier.initialize()
    ...
    stencil = 5
    trained_model_dummy_input_1 = torch.ones((1, stencil*4), dtype=torch.float32)
